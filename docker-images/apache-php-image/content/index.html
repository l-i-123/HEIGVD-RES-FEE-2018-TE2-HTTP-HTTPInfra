...
?>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#">Welcome to HEIG-VD</a>
    ...
    <header class="masthead text-center text-white">
      <div class="masthead-content">
        <div class="container">
		  ...
		  <h2 class="info_adresse" href="#"><?php print "$mon_ip"?></h2>
	...
	<script src="js/adresse_ip.js"></script>
